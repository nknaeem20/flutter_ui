...
import 'package:flutter_application_1/12minimal_profile.dart';
...
class _TravelbodyState extends State<Travelbody> with SingleTickerProviderStateMixin{
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'travelogram',
                  style: TextStyle(fontSize: 20.0, color: Colors.grey.shade900),
                ),
                ...
                InkWell(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context)=>MinimalProfile()));
                  },
                )
              ],
            ),
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                child: Container(
                  height: 20.0,
                  width: 20.0,
                  child: Image.asset('assets/chatbubble1.png'),
                ),
              ),
              SizedBox(width: 10.0),
              InkWell(
